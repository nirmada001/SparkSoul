...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="resources/css/main.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" type="text/css" href="resources/css/style.css?v=<?php echo time(); ?>">
    <style>
        .container{
            margin: 40px auto;
            width: 500px;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="tabcontent" id="signup">
                <form method="post" onsubmit="return validateRegister()" enctype="multipart/form-data">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // A form is posted
    ...
    if (isset($_POST['register'])) { // Register process
        ...
        // Insert Data
        $sql = "INSERT INTO users(user_firstname, user_lastname, user_nickname, user_password, user_email, user_gender, user_birthdate, user_status, user_about, user_hometown, u_image)
                VALUES ('$userfirstname', '$userlastname', '$usernickname', '$userpassword', '$useremail', '$usergender', '$userbirthdate', '$userstatus', '$userabout', '$userhometown', '$file')";
